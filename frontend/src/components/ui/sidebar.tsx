...
function SidebarProvider({
  ...
  // The internal state of the sidebar.
...
function SidebarMenuSkeleton({
  ...
  // Use a fixed width or a stable seed to avoid hydration mismatch
  // If you want random-looking widths, use an index-based approach or
  // wrap this in a useEffect to only run on client.
